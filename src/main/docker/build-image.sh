...
apt-get install --assume-yes --no-install-recommends python-dev dh-virtualenv gcc-multilib clang cmake libxml2-dev libxslt-dev libpq-dev libffi-dev libjpeg62-turbo-dev libpng-dev zlib1g-dev libssl-dev build-essential devscripts equivs git sudo
